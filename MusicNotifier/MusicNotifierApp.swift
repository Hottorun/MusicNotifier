    ...
    var body: some Scene {
        ...
        .commands {
            ...
            CommandMenu("Go") {
                ...
                // Gated on the same flags the tab bar / sidebar use. These
                // were always listed, so picking "Concerts" (a tab that is
                // force-disabled) or "Videos" (off by default) silently
